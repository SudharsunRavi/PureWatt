...
const Proposal = () => {
    ...
    return (
        <div>
            <Toaster />
            <h1 className="m-2 font-bold text-3xl py-4">Project Proposal</h1>
            <div>
                <form onSubmit={handleSubmit} className="w-11/12 md:w-4/12 absolute p-12 bg-black bg-opacity-80 rounded-sm my-auto mx-auto right-0 left-0 text-white">
                    ...
                    <div className="flex flex-row items-center gap-2 mt-2">
                        ...
                        <button type="button" disabled={uploadingImages} className="bg-arshabodhini_brown text-white p-3 rounded-lg hover:bg-arshabodhini_brown" onClick={handleImageSubmit}>{uploadingImages ? "Uploading..." : "UPLOAD"}</button>
                    </div>
